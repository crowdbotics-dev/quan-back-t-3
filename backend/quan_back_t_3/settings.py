"""
Django settings for quan_back_t_3 project.
...
ROOT_URLCONF = 'quan_back_t_3.urls'
...
WSGI_APPLICATION = 'quan_back_t_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quan_back_t_3 API",
    "DESCRIPTION": "API documentation for quan_back_t_3 App",
    "VERSION": "v1",
}
